...
COST = ["none", "mild", "high"]   # label for the bucketed social_cost
...
def main() -> None:
    ...
    for gid, g in gens.items():
        ...
        rows.append({
            ...
            # Prefer what generate.py recorded; older rows predate that field
            # and all used the belief wording.
            "prompt_sent_verbatim": g.get("prompt_sent")
                                    or f"{g['prompt']}\n\n{C.FORMAT_SUFFIX}",
            ...
            "originality_0_100": a.get("originality", ""),
            "cost_to_say_out_loud_0_100": a.get("social_cost_score", ""),
    ...
    for line in open(C.DATA / "audit.jsonl"):
        ...
        jrows.append({
            ...
            "originality_0_100": r.get("originality"),
            "cost_to_say_out_loud_0_100": r["social_cost"],
